    ...
    public class AsteroidSpawner : MonoBehaviour
    {
        ...
        private void Spawn()
        {
            ...
            for (var i = 0; i < amount; i++)
            {
                ...
                Asteroid spawnedAsteroid = Instantiate(_asteroidPrefab, position, Quaternion.identity);
                asteroidRuntimeSet.Add(spawnedAsteroid.GetInstanceID(), spawnedAsteroid); // The only change in the script to add newly spawned asteroids to the runtime set
            }
        }
